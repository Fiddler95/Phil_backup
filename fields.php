...
$tags_help_text = addslashes("Write at least 5 tags separate with a comma, writing something not already selected in “name of author”or “category”. Start from titles of books (write 'book: title_of_book'), and names of theories related to the topic/author or mentioned in the speech. Next think about other authors related, names of specific problems under discussion, names of schools of thought, etc... <br>Ex: Philosophical investigations, Metaphysics, Discourse on the method, etc. or Family resemblance, Context principle, Vienna Circle, etc");
